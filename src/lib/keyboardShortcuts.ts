...
export const KEYBOARD_SHORTCUTS: KeyboardShortcut[] = [
  ...
  { key: 'K', modifiers: mod, context: 'global', description: 'Quick actions (command palette)', category: 'View', action: 'commandPalette' },
  { key: 'P', modifiers: 'Ctrl', context: 'global', description: 'Quick actions (alternative)', category: 'View', action: 'commandPalette' },
