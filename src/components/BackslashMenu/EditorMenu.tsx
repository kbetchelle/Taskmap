...
/**
 * Inline backslash menu for the ContentEditor.
 * This is the editor-context variant that appears when `\` is typed inside a
 * contentEditable field. It uses the legacy Command interface with `action`.
 */
